...
class Filter
{
     ...
     * @param string $prefix
     */
    public function addDirectoryToWhitelist($directory, $suffix = 'EightController.phproller.php', $prefix = '')
    {
     ...
     * @param string $prefix
     */
    public function removeDirectoryFromWhitelist($directory, $suffix = 'EightController.phproller.php', $prefix = '')
    {
        $facade = new \File_Iterator_Facade;
        $files  = $facade->getFilesAsArray($directory, $suffix, $prefix);
