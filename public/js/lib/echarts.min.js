!function(t, e) {
	...
	return function(t) {
		...
		function o(t, e) {
			for (var i = t[0], o = 1, r = t.length; o < r; o++)
				i = n(i, t[o], e);
			return i
		}
		function r(t, e) {
		...
		function c(t, e) {
			for (var i = "component" === t, n = i ? this._componentsViews : this._chartsViews, o = i ? this._componentsMap : this._chartsMap, r = this._zr, a = 0; a < n.length; a++)
				n[a].__alive = !1;
			...
			N(Q, function(t) {
				this._zr.on(t, function(e) {
					...
					if ("globalout" === t)
						...
						o && o.eventData && (i = z.extend({}, o.eventData));
		...
		function r(t) {
			if (t.__hoverStlDirty) {
				...
				var a = {};
				for (var s in r)
					r.hasOwnProperty(s) && (a[s] = t.style[s]);
		...
		n.linearMap = function(t, e, i, n) {
			...
			for (var i = -(1 / 0), n = 1, o = 0; o < t.length;) {
				for (var r = t[o].interval, a = t[o].close, s = 0; s < 2; s++)
					r[s] <= i && (r[s] = i, a[s] = s ? 1 : 1 - n), i = r[s], n = a[s];
		...
		h.normalizeToArray = function(t) {
			...
			getRawValue: function(t, e) {
				...
				if (null != n)
					return !u(n) || n instanceof Array ? n : n.value
			},
			...
			return l(e, function(t, n) {
				if (u(t)) {
					...
					for (var o = 0; o < i.length; o++) {
						var r = i[o].exist;
						if (!(i[o].option || null != r.id && null != t.id || null == t.name || h.isIdInner(t) || h.isIdInner(r) || r.name !== t.name + ""))
							return i[o].option = t, void (e[n] = null)
					}
				}
			}), l(e, function(t, e) {
			...
			l(t, function(t, i) {
				...
				var n = t.exist,
					...
					r = t.keyInfo;
				if (u(o)) {
					if (r.name = null != o.name ? o.name + "" : n ? n.name : "\0-", n)
						r.id = n.id;
					else if (null != o.id)
						r.id = o.id + "";
					else {
						var a = 0;
						do r.id = "\0" + r.name + "\0" + a++;
						while (e[r.id])
					}
					e[r.id] = t
				}
		...
		n.prototype = {
			...
			contain: function(t, e) {
				...
				if (t = i[0], e = i[1], n.contain(t, e)) {
					...
					if (o.hasStroke()) {
						...
						if (l > 1e-10 && (o.hasFill() || (a = Math.max(a, this.strokeContainThreshold)), s.containStroke(r, a / l, t, e)))
							return !0
					}
					if (o.hasFill())
						return s.contain(r, t, e)
				}
				return !1
			},
			dirty: function(t) {
			...
			var e = function(e) {
				...
				if (i) {
					...
					var o = this.shape;
					for (var r in i)
						!o.hasOwnProperty(r) && i.hasOwnProperty(r) && (o[r] = i[r])
				}
		...
		h.box = n, h.vbox = o.curry(n, "vertical"), h.hbox = o.curry(n, "horizontal"), h.getAvailableSize = function(t, e, i) {
			...
			if (s || l) {
				var c;
				if ("raw" === u)
					c = "group" === t.type ? new r(0, 0, +e.width || 0, +e.height || 0) : t.getBoundingRect();
		...
		(function(e) {
			...
			y.type = "list", y.hasItemOption = !0, y.getDimension = function(t) {
				...
				e = n && n.stackable && e;
				var o,
					r = (this._extent || (this._extent = {}))[t + !!e];
				if (r)
					return r;
				if (i) {
					for (var a = 1 / 0, s = -(1 / 0), l = 0, u = this.count(); l < u; l++)
						o = this.get(t, l, e), o < a && (a = o), o > s && (s = o);
				...
				for (var u = 0; u < l.length; u++) {
					var h;
					if (1 === s)
						h = e.call(o, this.get(t[0], u, i), u);
					else {
						for (var c = 0; c < s; c++)
							a[c] = this.get(t[c], u, i);
						a[c] = u, h = e.apply(o, a)
					}
					h && r.push(l[u])
				}
				...
				for (var r = o(this, [t]), a = this._storage, s = r._storage, l = this.indices, u = r.indices = [], h = [], c = [], d = Math.floor(1 / e), f = s[t], p = this.count(), g = 0; g < a[t].length; g++)
					s[t][g] = a[t][g];
				for (var g = 0; g < p; g += d) {
		...
		function n(t, e) {
			...
			if (l[i])
				return l[i];
			for (var n = (t + "").split("\n"), o = 0, r = 0, a = n.length; r < a; r++)
				o = Math.max(p.measureText(n[r], e).width, o);
		...
		function a(t, e, i, o, r) {
			if (!e)
				return "";
			r = r || {}, o = f(o, "...");
			for (var a = f(r.maxIterations, 2), l = f(r.minChar, 0), u = n("国", i), h = n("a", i), c = f(r.placeholder, ""), d = e = Math.max(0, e - 1), p = 0; p < l && d >= h; p++)
				d -= h;
			var g = n(o);
			g > d && (o = "", g = 0), d = e - g;
		...
		function h(t, e, i, n, o, a, s, l, u, h, c) {
			...
			for (var _ = 0; _ < 1; _ += .05)
				A[0] = r(t, i, o, s, _), A[1] = r(e, n, a, l, _), g = x(I, A), g < y && (d = _, y = g);
			y = 1 / 0;
			for (var w = 0; w < 32 && !(v < S); w++)
				f = d - v, p = d + v, A[0] = r(t, i, o, s, f), A[1] = r(e, n, a, l, f), g = x(A, I), f >= 0 && g < y ? (d = f, y = g) : (L[0] = r(t, i, o, s, p), L[1] = r(e, n, a, l, p), m = x(L, I), p <= 1 && m < y ? (d = p, y = m) : v *= .5);
		...
		function m(t, e, i, o) {
			if (t = u(t))
				return t = c(t), null != e && (t[0] = n(e)), null != i && (t[1] = a(i)), null != o && (t[2] = a(o)), y(h(t), "rgba")
		}
		function v(t, e) {
			if (t = u(t), t && null != e)
				return t[3] = o(e), y(t, "rgba")
		}
		function y(t, e) {
			var i = t[0] + "," + t[1] + "," + t[2];
		...
		n.prototype = {
			...
			off: function(t, e) {
				...
				if (e) {
					if (i[t]) {
						for (var n = [], o = 0, r = i[t].length; o < r; o++)
		...
		function a(t, e, i) {
			...
			if (r) {
				...
				o(t, e, e, i), e.zrDelta = e.wheelDelta ? e.wheelDelta / 120 : -(e.detail || 0) / 3;
			return e
		}
		function s(t, e, i) {
		...
		var n = i(3),
			...
			c = {};
		for (var d in u)
			u.hasOwnProperty(d) && (c[d] = new u[d]);
		var f = n.extendShape({
				type: "symbol",
				shape: {
					symbolType: "",
		...
		_.prototype = {
			...
			appendPath: function(t) {
				...
				for (var o = 0; o < e; o++)
					for (var r = t[o].data, a = 0; a < r.length; a++)
						this.data[n++] = r[a];
				this._len = n
			},
			addData: function(t) {
			...
			_dashedLineTo: function(t, e) {
				var i,
					...
					m = u,
					y = a.length;
				for (h /= d, c /= d, r < 0 && (r = o + r), r %= o, g -= r * h, m -= r * c; h > 0 && g <= t || h < 0 && g >= t || 0 == h && (c > 0 && m <= e || c < 0 && m >= e);)
					n = this._dashIdx, i = a[n], g += h * i, m += c * i, this._dashIdx = (n + 1) % y, h > 0 && g < l || h < 0 && g > l || c > 0 && m < u || c < 0 && m > u || s[n % 2 ? "moveTo" : "lineTo"](h >= 0 ? f(g, t) : p(g, t), c >= 0 ? f(m, e) : p(m, e));
			...
			_dashedBezierTo: function(t, e, i, o, r, a) {
				...
				for (f < 0 && (f = d + f), f %= d, s = 0; s < 1; s += .1)
					l = x(m, t, i, r, s + .1) - x(m, t, i, r, s), u = x(y, e, o, a, s + .1) - x(y, e, o, a, s), _ += v(l * l + u * u);
				for (; b < w && (S += p[b], !(S > f)); b++)
					;
				for (s = (S - f) / _; s <= 1;)
					h = x(m, t, i, r, s), c = x(y, e, o, a, s), b % 2 ? g.moveTo(h, c) : g.lineTo(h, c), s += p[b] / _, b = (b + 1) % w;
			...
			h = r.extend({
				...
				getTicks: function() {
					...
					if (t) {
						...
						e[0] < o[0] && i.push(e[0]);
						for (var a = o[0]; a <= o[1];)
							if (i.push(a), a = u(a + t, r), i.length > n)
								return [];
					...
					t && d(function(e) {
						if (t) {
							...
							if (o.length && !n.length)
								for (var r = 0, a = o.length; r < a; r++)
									"category" === o[r].get("type") && n.push(r);
		...
		l.prototype = {
			...
			getBands: function() {
				for (var t = this.getExtent(), e = [], i = this.scale.count(), n = t[0], o = t[1], r = o - n, a = 0; a < i; a++)
					e.push([r * a / i + n, r * (a + 1) / i + n]);
				return e
			},
		...
		function r(t, e, i, n, o) {
			for (n === e && n++; n < i; n++) {
				for (var r, a = t[n], s = e, l = n; s < l;)
					r = s + l >>> 1, o(a, t[r]) < 0 ? l = r : s = r + 1;
				var u = n - s;
				switch (u) {
					case 3:
						t[s + 3] = t[s + 2];
		...
		function a(t, e, i, n, o, r) {
			var a = 0,
				...
				l = 1;
			if (r(t, e[i + o]) > 0) {
				for (s = n - o; l < s && r(t, e[i + o + l]) > 0;)
					a = l, l = (l << 1) + 1, l <= 0 && (l = s);
				l > s && (l = s), a += o, l += o
			} else {
				for (s = o + 1; l < s && r(t, e[i + o - l]) <= 0;)
					a = l, l = (l << 1) + 1, l <= 0 && (l = s);
				l > s && (l = s);
				var u = a;
				a = o - l, l = o - u
					...
					for (var m = p;;) {
						...
						do {
							...
							if (y = r - a(t[u], x, 0, r, r - 1, e), 0 !== y) {
								for (d -= y, h -= y, r -= y, g = d + 1, f = h + 1, l = 0; l < y; l++)
									t[g + l] = x[f + l];
								if (r <= 1) {
									_ = !0;
									break
		...
		function u(t, e, o, a) {
			...
			if (!(s < 2)) {
				var u = 0;
				if (s < h)
					return u = n(t, o, a, e), void r(t, o, a, o + u, e);
				var c = new l(t, e),
					d = i(s);
				do {
					if (u = n(t, o, a, e), u < d) {
		...
		n.prototype = {
			...
			brush: function(t, e) {
				...
				if (n.bind(t, this, e), i = "string" == typeof o ? this._image : o, !i && o) {
					...
					if (i = r.image, this._image = i, !i.width || !i.height)
		...
		v.type = "grid", v.getRect = function() {
			...
			var i,
				...
				l = this._coordsList;
			if (o)
				i = o.coordinateSystem, c.indexOf(l, i) < 0 && (i = null);
			else if (r && a)
				i = this.getCartesian(r.componentIndex, a.componentIndex);
			else if (r)
		...
		function h(t, e, i, n, o, r, a, s, l) {
			...
			if (1 == l)
				for (var h = 0; h < u; h++)
					s[h] = c(t[h], e[h], i[h], n[h], o, r, a);
			else
				for (var d = t[0].length, h = 0; h < u; h++)
					for (var f = 0; f < d; f++)
						s[h][f] = c(t[h][f], e[h][f], i[h][f], n[h][f], o, r, a)
		}
		...
		function p(t, e, i, n, o) {
			...
			if (x) {
				...
				if (!C) {
					for (var O = A[x - 1], D = 0; D < x - 1; D++)
						w ? l(A[D], O, T) : !isNaN(A[D]) || isNaN(O) || M || S || (A[D] = O);
					...
					var W = function(t, e) {
							...
							if (0 !== n)
								if (E = (e - I[i]) / n, v)
									if (V = A[i], R = A[0 === i ? i : i - 1], N = A[i > x - 2 ? x - 1 : i + 1], B = A[i > x - 3 ? x - 1 : i + 2], w)
										h(R, V, N, B, E, E * E, E * E * E, d(t, o), T);
									else {
										var l;
										if (S)
											l = h(R, V, N, B, E, E * E, E * E * E, H, 1), l = f(H);
										else {
											if (M)
												return a(V, N, E);
									...
									s(A[i], A[i + 1], E, d(t, o), T);
								else {
									var l;
									if (S)
										s(A[i], A[i + 1], E, H, 1), l = f(H);
									else {
										if (M)
											return a(A[i], A[i + 1], E);
										l = r(A[i], A[i + 1], E)
									}
									p(t, o, l)
								}
		...
		r.prototype = {
			...
			getGradient: function(t, e, o) {
				for (var r = "radial" === e.type ? n : i, a = r(t, e, o), s = e.colorStops, l = 0; l < s.length; l++)
		...
		t.exports = i(2).extendComponentView({
			...
			render: function(t, e, i) {
				...
				for (var o in n)
					n.hasOwnProperty(o) && (n[o].__keep = !1);
				...
				for (var o in n)
					n.hasOwnProperty(o) && !n[o].__keep && this.group.remove(n[o].group)
			},
		...
		_.listVisualTypes = function() {
			...
			var n,
				o = p.isArray(t) ? [] : p.isObject(t) ? {} : (n = !0, null);
			...
			for (var a = 0, s = e.length; a < s; a++) {
				...
				if (h) {
					if (h[0] === -(1 / 0)) {
						...
						if (f(c[0], h[0], t))
							return a
					} else if (f(c[0], h[0], t) && f(c[1], t, h[1]))
						return a;
					i && n(h[0], a), i && n(h[1], a)
				}
			}
		...
		r.fromPoints = function(t, e, i) {
			if (0 !== t.length) {
				...
				for (n = 1; n < t.length; n++)
					o = t[n], r = a(r, o[0]), l = s(l, o[0]), u = a(u, o[1]), h = s(h, o[1]);
		...
		r.fromCubic = function(t, e, i, n, r, l, u, h, c, d) {
			...
			var m = n.min,
				...
				y = Math.abs(r - a);
			if (y % f < 1e-4 && y > 1e-4)
				return p[0] = t - i, p[1] = e - o, g[0] = t + i, void (g[1] = e + o);
			...
			for (var _ = 0; _ < a; _ += Math.PI / 2)
				_ > r && (d[0] = u(_) * i + t, d[1] = l(_) * o + e, m(p, d, p), v(g, d, g))
		}, t.exports = r
	}, function(t, e, i) {
		var n = i(36),
			o = i(1),
			...
			brush: function(t, e) {
				...
				if (null != a && (a += ""), i.bind(t, this, e), a) {
					...
					for (var c = r.measureText("国", t.font).width, d = a.split("\n"), f = 0; f < d.length; f++)
						i.hasFill() && t.fillText(d[f], n, o), i.hasStroke() && t.strokeText(d[f], n, o), o += c;
			...
			drawRectText: function(t, e, i) {
				...
				if (null != s && (s += ""), s) {
					...
					for (var b = 0; b < _.length; b++)
						y && t.fillText(_[b], l, u), x && t.strokeText(_[b], l, u), u += i.lineHeight;
					t.restore()
				}
			}
		}, t.exports = s
		...
		t.exports = {
			containStroke: function(t, e, i, n, o, r, a) {
				...
				var s = o,
					l = 0,
					u = t;
				if (a > e + s && a > n + s || a < e - s && a < n - s || r > t + s && r > i + s || r < t - s && r < i - s)
					return !1;
				if (t === i)
		...
		t.exports = {
			containStroke: function(t, e, i, o, r, a, s, l, u) {
				if (0 === s)
					return !1;
				var h = s;
				if (u > e + h && u > o + h && u > a + h || u < e - h && u < o - h && u < a - h || l > t + h && l > i + h && l > r + h || l < t - h && l < i - h && l < r - h)
					return !1;
		...
		function s() {
			...
			if (e || i || !n.ignore) {
				for (var o = 1, r = this.parent; r;)
					r.scale && (o /= r.scale[0]), r = r.parent;
				...
				if (this.__dirty || a.__dirty) {
					...
					if (!n.ignore) {
						...
						var f,
							...
							m = 5 * o;
						if ("end" === n.__position)
							f = [c[0] * m + u[0], c[1] * m + u[1]], p = c[0] > .8 ? "left" : c[0] < -.8 ? "right" : "center", g = c[1] > .8 ? "top" : c[1] < -.8 ? "bottom" : "middle";
		...
		function o(t, e, i, o, r, a, g, m, v, y, x) {
			for (var _ = 0, b = i, w = 0; w < o; w++) {
				...
				if (b === i)
					t[a > 0 ? "moveTo" : "lineTo"](S[0], S[1]), c(f, S);
				else if (v > 0) {
					var M = b + a,
						T = e[M];
					if (x)
		...
		function n(t, e, i, n, o, r, a) {
			function s(e, i, n, o) {
				for (var r = e; r < i; r++)
					if (t[r].y += n, r > e && r + 1 < i && t[r + 1].y > t[r].y + t[r].height)
						return void l(r, n / 2);
				l(i - 1, n / 2)
			}
			function l(e, i) {
			...
			for (var h, c = 0, d = t.length, f = [], p = [], g = 0; g < d; g++)
				h = t[g].y - c, h < 0 && s(g, d, -h, o), c = t[g].y + t[g].height;
			a - c < 0 && l(d - 1, c - a);
			for (var g = 0; g < d; g++)
			...
			e.eachSeriesByType(t, function(t) {
				...
				if (v.each("value", function(t, e) {
					...
					if (T <= .001) {
						...
						b = T / I, A = y, v.each("value", function(t, e) {
		...
		function z(t, e, i) {
			...
			if (t._track.push(t.group.transformCoordToLocal(o, r)), m(t) || u) {
				...
				i && "single" === c.brushMode && c.removeOnClick && d(t, o, r) && p(t) && (n = {
					isEnd: i,
					removeOnClick: !0
				});
			return n
			...
			w = d.extend({
					...
					function e(e, o) {
						...
						i[e] = [], n[e] = [], f(u, function(t, o) {
							...
							if (h.assert(y(a) || r, "Empty component definition"), a) {
								...
								if (r && r instanceof s)
									r.name = t.keyInfo.name, r.mergeOption(a, this), r.optionUpdated(a, !1);
								else {
									var l = h.extend({
										dependentModels: d,
										componentIndex: o
				...
				getOption: function() {
					...
					return f(t, function(e, i) {
						if (x.hasClass(i)) {
							for (var e = c.normalizeToArray(e), n = e.length - 1; n >= 0; n--)
		...
		function o(t, e, i, n) {
			e = e.split(",");
			for (var o, r = t, a = 0; a < e.length - 1; a++)
				o = e[a], null == r[o] && (r[o] = {}), r = r[o];
		...
		t.exports = function(t) {
			if (t) {
				...
				if (e) {
					...
					var r = t.markPoint;
					if (r && r.data)
						for (var a = r.data, i = 0; i < a.length; i++)
							n(a[i]);
					var s = t.markLine;
					if (s && s.data)
		...
		b.prototype = {
			...
			eachBuildinLayer: function(t, e) {
				...
				for (o = 0; o < r.length; o++)
					n = r[o], i = this._layers[n], i.isBuildin && t.call(e, i, n)
			},
			...
			_updateLayerStatus: function(t) {
				...
				for (var r, a, s = 0, l = 0, u = 0, h = t.length; u < h; u++) {
					...
					if (p && (p.elCount++, p.__dirty = p.__dirty || c.__dirty), g >= 0) {
						...
						c.__frame = -1, r && (r.__nextIdxNotProg = u, s++, r = null)
				}
		...
		t.exports = {
			containStroke: function(t, e, i, o, r, a, s, l, u, h, c) {
				if (0 === u)
					return !1;
				var d = u;
				if (c > e + d && c > o + d && c > a + d && c > l + d || c < e - d && c < o - d && c < a - d && c < l - d || h > t + d && h > i + d && h > r + d && h > s + d || h < t - d && h < i - d && h < r - d && h < s - d)
					return !1;
		...
		function r(t, e, i, n, r, a, s, l, u, h) {
			if (h > e && h > n && h > a && h > l || h < e && h < n && h < a && h < l)
				return 0;
		...
		function l(t, e, i, o, l) {
			for (var h = 0, p = 0, g = 0, y = 0, x = 0, _ = 0; _ < t.length;) {
				...
				switch (b === u.M && _ > 1 && (i || (h += m(p, g, y, x, o, l))), 1 == _ && (p = t[_], g = t[_ + 1], y = p, x = g), b) {
					...
					case u.L:
						if (i) {
							if (v(p, g, t[_], t[_ + 1], e, o, l))
								return !0
						} else
							h += m(p, g, t[_], t[_ + 1], o, l) || 0;
						p = t[_++], g = t[_++];
						break;
					case u.C:
						if (i) {
							if (c.containStroke(p, g, t[_++], t[_++], t[_++], t[_++], t[_], t[_ + 1], e, o, l))
								return !0
						} else
							h += r(p, g, t[_++], t[_++], t[_++], t[_++], t[_], t[_ + 1], o, l) || 0;
						p = t[_++], g = t[_++];
						break;
					case u.Q:
						if (i) {
							if (d.containStroke(p, g, t[_++], t[_++], t[_], t[_ + 1], e, o, l))
								return !0
						} else
							h += a(p, g, t[_++], t[_++], t[_], t[_ + 1], o, l) || 0;
						p = t[_++], g = t[_++];
						break;
					case u.A:
						var w = t[_++],
						...
						var P = (o - w) * T / M + w;
						if (i) {
							if (f.containStroke(w, S, T, I, I + A, L, e, P, l))
								return !0
						} else
							h += s(w, S, T, I, I + A, L, P, l);
					...
					case u.R:
						...
						var k = t[_++],
							...
							D = x + O;
						if (i) {
							if (v(y, x, C, x, e, o, l) || v(C, x, C, D, e, o, l) || v(C, D, y, D, e, o, l) || v(y, D, y, x, e, o, l))
								return !0
						} else
							h += m(C, x, C, D, o, l), h += m(y, D, y, x, o, l);
						break;
					case u.Z:
						if (i) {
							if (v(p, g, y, x, e, o, l))
		...
		var o = i(5);
		t.exports = function(t, e) {
			for (var i = t.length, r = [], a = 0, s = 1; s < i; s++)
				a += o.distance(t[s - 1], t[s]);
			var l = a / 2;
			l = l < i ? i : l;
			for (var s = 0; s < l; s++) {
				var u,
			...
			_animateToShallow: function(t, e, i, n, r) {
				...
				for (var u in i)
					if (i.hasOwnProperty(u))
						if (null != e[u])
							s(i[u]) && !o.isArrayLike(i[u]) ? this._animateToShallow(t ? t + "." + u : u, e[u], i[u], n, r) : (a[u] = i[u], l++);
						else if (null != i[u])
							if (t) {
								var h = {};
		...
		function o(t) {
			...
			for (e = 0; e < h.length; e++)
				i = i.replace(new RegExp(h[e], "g"), "|" + h[e]);
			var o,
				r = i.split("|"),
				a = 0,
				l = 0,
		...
		function n(t, e) {
			...
			if (d) {
				...
				i = t.getBoxLayoutParams(), i.aspect = c, f = a.getLayoutRect(i, {
					width: s,
					height: u
				});
		...
		var r = i(358),
			...
			h = {
				...
				getFilledRegions: function(t, e) {
					...
					if (!o)
						return t;
					for (var r = {}, a = o.features, s = 0; s < i.length; s++)
						r[i[s].name] = i[s];
		...
		var d = s.extendComponentModel({
			...
			optionUpdated: function(t, e) {
				...
				l.each(s, function(t, e) {
					...
					if (n) {
						...
						var d = l.extend({}, n),
							f = n.$action;
						if (f && "merge" !== f)
							"replace" === f ? o[e] = d : "remove" === f && i && (o[e] = null);
						else if (i) {
				...
				for (var d = o.length - 1; d >= 0; d--)
					null == o[d] ? o.splice(d, 1) : delete o[d].$action
			},
		...
		function a(t, e, i, o, r) {
			...
			if (isNaN(u) || isNaN(c)) {
				if (o.getMarkerPosition)
					a = o.getMarkerPosition(t.getValues(i, e));
				else {
					var d = t.get(i[0], e),
						f = t.get(i[1], e);
		...
		function a(t, e, i, o, r) {
			...
			if (isNaN(u) || isNaN(c)) {
				if (o.getMarkerPosition)
					a = o.getMarkerPosition(t.getValues(t.dimensions, e));
				else {
					var d = s.dimensions,
						f = t.get(d[0], e),
						p = t.get(d[1], e);
			...
			f = function(t, e, i, n) {
				...
				if (!l.isArray(n) && ("min" === r || "max" === r || "average" === r || null != n.xAxis || null != n.yAxis)) {
					...
					if (null != n.yAxis || null != n.xAxis)
						s = null != n.yAxis ? "y" : "x", a = e.getAxis(s), u = l.retrieve(n.yAxis, n.xAxis);
					else {
			...
			t.each(function(o) {
				...
				if (isNaN(l) || isNaN(u)) {
					if (e.getMarkerPosition)
						r = e.getMarkerPosition(t.getValues(t.dimensions, o));
					else if (n) {
		...
		function r(t) {
			return p.map(t, function(t) {
				...
				return e.each(e.dimensions, function() {
					for (var t = arguments.length, o = arguments[t - 1], r = e.getName(o), a = 0; a < t - 1; a++)
						n[a] = arguments[a];
		...
		d.defaultOption = {
			...
			if ("function" == typeof d) {
				...
				u.appendChild(h), h.readOnly = o.get("readOnly"), h.style.cssText = "width:100%;height:100%;font-family:monospace;font-size:14px;line-height:1.6rem;", h.style.color = o.get("textColor"), h.style.borderColor = o.get("textareaBorderColor"), h.style.backgroundColor = o.get("textareaColor"), h.value = m.value;
			var x = m.meta,
		...
		function h(t, e, i, n, o, r, a, h) {
			...
			if (a && f.applyTransform(a.transform), "function" == typeof t && (t = t([e, i], r, o.el, f)), p.isArray(t))
				e = y(t[0], c), i = y(t[1], d);
		...
		i(2).extendComponentView({
			...
			_manuallyShowTip: function(t) {
				function e(e) {
					...
					if (null != n && !p.isArray(n) && i.hasValue(n))
						return !0
				}
				if (t.from !== this.uid) {
					var i = this._ecModel,
			...
			_tryShow: function(t) {
				...
				if (i)
					if (this._lastX = t.offsetX, this._lastY = t.offsetY, e && null != e.dataIndex) {
						...
						"item" === n ? this._hide() : this._showAxisTooltip(i, o, t), "cross" === i.get("axisPointer.type") && r.dispatchAction({
							type: "showTip",
							from: this.uid,
							x: t.offsetX,
							y: t.offsetY
			...
			_dispatchAndShowSeriesTooltipContent: function(t, e, i, n, o, r) {
				...
				if (d.payloadBatch && !o && f.dispatchAction({
					...
					if (o)
						h(r || s.get("position"), i[0], i[1], s.get("confine"), this._tooltipContent, g, null, f);
					else {
		...
		if (!i(11).canvasSupported) {
			...
			h.prototype.brushVML = function(t) {
				...
				if (H(o)) {
					...
					o === this._imageSrc && (e = this._imageWidth, i = this._imageHeight);
				if (o) {
					var u = n.x || 0,
						h = n.y || 0,
						c = n.width,
					...
					if (this.transform && (I = this.transform, D = m(I[0] * I[0] + I[1] * I[1]), k = m(I[2] * I[2] + I[3] * I[3]), C = I[1] || I[2]), C) {
						...
						I && (u = u * D + I[4], h = h * k + I[5]), A.filter = "", A.left = g(u) + "px", A.top = g(h) + "px";
					var F = this._imageEl,
						W = this._cropEl;
					...
					if (M) {
						if (e && i)
							Z.width = g(D * e * c / f) + "px", Z.height = g(k * i * d / v) + "px";
						else {
							var q = new Image,
								j = this;
							q.onload = function() {
						...
						Z.width = g(D * c) + "px", Z.height = g(k * d) + "px", T.appendChild(F), W && W.parentNode && (T.removeChild(W), this._cropEl = null);
					var X = "",
						Y = n.opacity;
				...
				if (null != r && (r += ""), r) {
					...
					if (m && !n && ($.copy(e), $.applyTransform(m), e = $), n)
						...
						if (v instanceof Array)
							a = e.x + z(v[0], e.width), l = e.y + z(v[1], e.height), u = u || "left", d = d || "top";
						else {
		...
		t.exports = function(t, e, i, h, c) {
			for (var d = new o(h), f = 0; f < t.length; f++)
			...
			r = {
				getItemAlign: function(t, e, i) {
					...
					for (var a = {
						width: e.getWidth(),
						height: e.getHeight()
					}, s = "horizontal" === n.orient ? 1 : 0, l = [["left", "right", "width"], ["top", "bottom", "height"]], u = l[s], h = [0, null, 10], c = {}, d = 0; d < 3; d++)
						c[l[1 - s][d]] = h[d], c[u[d]] = 2 === d ? i[0] : n[u[d]];
		...
		n.prototype = {
			...
			getBoundingRect: function() {
				...
				if (t)
					return t;
				for (var e = Number.MAX_VALUE, i = [e, e], n = [-e, -e], o = [], l = [], u = this.contours, h = 0; h < u.length; h++)
					a.fromPoints(u[h], o, l), s.min(i, i, o), s.max(n, n, l);
			...
			transformTo: function(t, e, i, n) {
				...
				for (var l = new r(t, e, i, n), u = o.calculateTransform(l), h = this.contours, c = 0; c < h.length; c++)
					for (var d = 0; d < h[c].length; d++)
						s.applyTransform(h[c][d], h[c][d], u);
		...
		function o(t, e) {
			for (var i = t.mapArray("value", function(t) {
				return t
			}), n = [], o = "ascending" === e, r = 0, a = t.count(); r < a; r++)
				n[r] = r;
		...
		function r(t) {
			t.each(function(e) {
				...
				if (d)
					n = (c[0][0] + c[1][0] + c[2][0] + c[3][0]) / 4, o = (c[0][1] + c[1][1] + c[2][1] + c[3][1]) / 4, i = "center", r = [[n, o], [n, o]];
				else {
					var f,
						p,
						g,
						...
						b.step = function(t) {
							...
							w(function(e, n, o) {
								for (var r = 0, a = e.length; r < a; r++)
									e[r].fixed || u.getNodeByIndex(r).setLayout(e[r].p), i[h.getId(r)] = e[r].p;
		...
		n.prototype = {
			...
			_getGradient: function(t, e, i) {
				for (var n = this._gradientPixels, o = n[i] || (n[i] = new Uint8ClampedArray(1024)), r = [], a = 0, s = 0; s < 256; s++)
					e[i](s / 255, !0, r), o[a++] = r[0], o[a++] = r[1], o[a++] = r[2], o[a++] = r[3];
				return o
			}
		}, t.exports = n
	}, function(t, e, i) {
					...
					for (var i = e.segs, n = e.polyline, o = 0; o < i.length; o++) {
						...
						if (n) {
							...
							for (var a = 1; a < r.length; a++)
								t.lineTo(r[a][0], r[a][1])
						} else
							t.moveTo(r[0][0], r[0][1]), r.length > 2 ? t.quadraticCurveTo(r[2][0], r[2][1], r[1][0], r[1][1]) : t.lineTo(r[1][0], r[1][1])
					}
				},
				findDataIndex: function(t, e) {
					for (var i = this.shape, n = i.segs, o = i.polyline, s = Math.max(this.style.lineWidth, 1), l = 0; l < n.length; l++) {
						...
						if (o) {
							for (var h = 1; h < u.length; h++)
								if (a.containStroke(u[h - 1][0], u[h - 1][1], u[h][0], u[h][1], s, t, e))
									return l
						} else if (u.length > 2) {
							if (r.containStroke(u[0][0], u[0][1], u[2][0], u[2][1], u[1][0], u[1][1], s, t, e))
								return l
						} else if (a.containStroke(u[0][0], u[0][1], u[1][0], u[1][1], s, t, e))
							return l
					}
					return -1
				}
		...
		function n(t, e) {
			...
			return t[0].map(n, function(n, o) {
				for (var r = t[0].getName(o), a = 0, s = 1 / 0, l = -(1 / 0), u = i[r].length, h = 0; h < u; h++)
					s = Math.min(s, i[r][h]), l = Math.max(l, i[r][h]), a += i[r][h];
				var c;
		...
		t.exports = function(t) {
			...
			t.eachSeriesByType("map", function(t) {
				...
				for (var i = n(o.map(t, function(t) {
					return t.getData()
				}), t[0].get("mapValueCalculation")), r = 0; r < t.length; r++)
					t[r].originalData = t[r].getData();
				for (var r = 0; r < t.length; r++)
					t[r].seriesGroup = t, t[r].needsDrawMap = 0 === r, t[r].setData(i.cloneShallow()), t[r].mainSeries = t[0]
			})
		}
	}, function(t, e, i) {
		var n = i(1);
		...
		function a(t, e, i) {
			for (var n = t, o = null, r = 0, a = 0; n.length;) {
				...
				for (var u = 0, h = n.length; u < h; u++) {
					...
					for (var d = 0, f = c.outEdges.length; d < f; d++)
		...
		function u(t, e, i, n, o) {
			...
			h(t, r, e, i, n), c(r, n, i);
			for (var a = 1; o > 0; o--)
				a *= .99, d(r, a), c(r, n, i), p(r, a), c(r, n, i)
		}
		...
		function c(t, e, i) {
			I.each(t, function(t) {
				...
				if (o = a - e - i, o > 0) {
					...
					for (n.setLayout({
						y: l
					}, !0), a = n.getLayout().y, r = s - 2; r >= 0; --r)
						n = t[r], o = n.getLayout().y + n.getLayout().dy + e - a, o > 0 && (l = n.getLayout().y - o, n.setLayout({
							y: l
						}, !0)), a = n.getLayout().y
				}
			})
			...
			if (u) {
				...
				if (I && I.isInView) {
					var A = I.width,
						...
						k = x("nodeGroup", m);
					if (k) {
						if (c.add(k), k.attr("position", [I.x || 0, I.y || 0]), k.__tmNodeWidth = A, k.__tmNodeHeight = L, I.isAboveViewRoot)
							return k;
				...
				return n.eachNode({
					...
					if (o) {
						var r = o.transformCoordToLocal(t, e),
							a = o.shape;
						if (!(a.x <= r[0] && r[0] <= a.x + a.width && a.y <= r[1] && r[1] <= a.y + a.height))
							return !1;
						i = {
							node: n,
							offsetX: r[0],
		...
		for (var n = i(2), o = i(79), r = function() {}, a = ["treemapZoomToNode", "treemapRender", "treemapMove"], s = 0; s < a.length; s++)
			n.registerAction({
				type: a[s],
				update: "updateView"
			}, r);
		...
		function r(t, e, i, n, o, r) {
			...
			if (0 === d.sum)
				return t.viewChildren = [];
			if (d.sum = a(e, i, d.sum, h, u), 0 === d.sum)
				return t.viewChildren = [];
		...
		function l(t, e, i) {
			for (var n = 0, o = 0, r = e.length; o < r; o++)
				n += e[o].getValue();
			var a,
				s = t.get("visualDimension");
			if (e && e.length)
				if ("value" === s && i)
					a = [e[e.length - 1].getValue(), e[0].getValue()], "asc" === i && a.reverse();
				else {
					var a = [1 / 0, -(1 / 0)];
					S(e, function(t) {
						var e = t.getValue(s);
		...
		function u(t, e, i) {
			for (var n, o = 0, r = 1 / 0, a = 0, s = t.length; a < s; a++)
				n = t[a].getLayout().area,
				n && (n < r && (r = n), n > o && (o = n));
			var l = t.area * t.area,
				u = e * e * i;
		...
		i(2).extendComponentView({
			...
			_splitLine: function(t, e, i, a) {
				...
				for (var d = 0; d < c.length; d++)
					this.group.add(r.mergePath(c[d], {
						style: o.defaults({
							stroke: u[d % u.length]
						}, l.getLineStyle()),
						silent: !0,
			...
			_splitArea: function(t, e, i, n) {
				...
				for (var m = 0; m < h.length; m++)
					this.group.add(r.mergePath(h[m], {
						style: o.defaults({
							fill: l[m % l.length]
						}, s.getAreaStyle()),
						silent: !0
				...
				render: function(t, e, i, a) {
					if (!n(t, e, a)) {
						...
						if (this._axisGroup = new s.Group, this.group.add(this._axisGroup), t.get("show")) {
							var h,
								c = e.getComponent("parallel", t.get("parallelIndex")).coordinateSystem,
		...
		i(2).extendComponentView({
			...
			_splitArea: function(t, e, i, n, a) {
				...
				for (var f = 0; f < c.length; f++)
					this.group.add(r.mergePath(c[f], {
						style: o.defaults({
							fill: u[f % u.length]
						}, l.getAreaStyle()),
						silent: !0
			...
			c = i(2).extendComponentView({
				...
				_splitLine: function(t, e) {
					...
					for (var y = 0; y < f.length; ++y)
						this.group.add(a.mergePath(f[y], {
							style: {
								stroke: u[y % u.length],
		...
		function r(t, e, i, n) {
			for (var o = i.getItemLayout(n), r = 0, a = e.length; r < a; r++) {
				var s = e[r];
				if (t[s.brushType](o, s.selectors, s))
					return !0
			}
		}
		function a(t) {
		...
		function r(t, e, i, n, o, r) {
			var a = e.get("color");
			if (o)
				o.setColor(a), i.add(o), r && r.onUpdate(o);
			else {
				var l = t.get("symbol");
		...
		function n(t, e, i) {
			if (i[0] === i[1])
				return i.slice();
			for (var n = 200, o = (i[1] - i[0]) / n, r = i[0], a = [], s = 0; s <= n && r < i[1]; s++)
				a.push(r), r += o;
			return a.push(i[1]), a
		}
		var o = i(232),
			...
			l = o.extend({
				...
				getVisualMeta: function(t) {
					...
					for (var i = n(this, "outOfRange", this.getExtent()), o = n(this, "inRange", this.option.range.slice()), r = [], a = 0, s = 0, l = o.length, u = i.length; s < u && (!o.length || i[s] <= o[0]); s++)
						i[s] < o[a] && e(i[s], "outOfRange");
					for (var h = 1; a < l; a++, h = 0)
						h && r.length && e(o[a], "outOfRange"), e(o[a], "inRange");
					for (var h = 1; s < u; s++)
						(!o.length || o[o.length - 1] < i[s]) && (h && (r.length && e(r[r.length - 1].value, "outOfRange"), h = 0), e(i[s], "outOfRange"));
					var c = r.length;
					return {
						stops: r,
		...
		for (var n = i(240), o = [126, 25], r = [[[0, 3.5], [7, 11.2], [15, 11.9], [30, 7], [42, .7], [52, .7], [56, 7.7], [59, .7], [64, .7], [64, 0], [5, 0], [0, 3.5]], [[13, 16.1], [19, 14.7], [16, 21.7], [11, 23.1], [13, 16.1]], [[12, 32.2], [14, 38.5], [15, 38.5], [13, 32.2], [12, 32.2]], [[16, 47.6], [12, 53.2], [13, 53.2], [18, 47.6], [16, 47.6]], [[6, 64.4], [8, 70], [9, 70], [8, 64.4], [6, 64.4]], [[23, 82.6], [29, 79.8], [30, 79.8], [25, 82.6], [23, 82.6]], [[37, 70.7], [43, 62.3], [44, 62.3], [39, 70.7], [37, 70.7]], [[48, 51.1], [51, 45.5], [53, 45.5], [50, 51.1], [48, 51.1]], [[51, 35], [51, 28.7], [53, 28.7], [53, 35], [51, 35]], [[52, 22.4], [55, 17.5], [56, 17.5], [53, 22.4], [52, 22.4]], [[58, 12.6], [62, 7], [63, 7], [60, 12.6], [58, 12.6]], [[0, 3.5], [0, 93.1], [64, 93.1], [64, 0], [63, 0], [63, 92.4], [1, 92.4], [1, 3.5], [0, 3.5]]], a = 0; a < r.length; a++)
			for (var s = 0; s < r[a].length; s++)
				r[a][s][0] /= 10.5, r[a][s][1] /= -14, r[a][s][0] += o[0], r[a][s][1] += o[1];
		t.exports = function(t) {
		...
		r.prototype = {
			...
			pointToCoord: function(t) {
				...
				e /= s, i /= s;
				for (var l = Math.atan2(-i, e) / Math.PI * 180, u = l < r ? 1 : -1; l < r || l > a;)
					l += 360 * u;
				return [s, l]
			},
		...
		n.prototype.getIndicatorAxes = function() {
			...
			o.each(n, function(t, e) {
				...
				if (null != u && null != h)
					...
					var d;
					do d = u + c * a, r.setExtent(+u, d), r.setInterval(c), c = i(c);
					while (d < n[1] && isFinite(d) && isFinite(n[1]))
				} else if (null != h) {
					var f;
					do f = h - c * a, r.setExtent(f, +h), r.setInterval(c), c = i(c);
					...
					var t = this.get("boundaryGap"),
						...
						p = s.map(this.get("indicator") || [], function(p) {
							if (null != p.max && p.max > 0 && !p.min ? p.min = 0 : null != p.min && p.min < 0 && !p.max && (p.max = 0), p = s.merge(s.clone(p), {
								...
								"function" == typeof c && (p.name = c(p.name, p));
			...
			getLabelInterval: function() {
				...
				if (!t) {
					var e = this.model,
						i = e.getModel("axisLabel"),
						o = i.get("interval");
					if ("category" !== this.type || "auto" !== o)
						return t = this._labelInterval = "auto" === o ? 0 : o;
		...
		s.type = "graph", s.isDirected = function() {
			...
			if (e instanceof n || (e = this._nodesMap[e]), e) {
				for (var r = "out" === i ? "outEdges" : "in" === i ? "inEdges" : "edges", a = 0; a < this.nodes.length; a++)
			...
			for (var t = this.data, e = this.edgeData, i = this.nodes, n = this.edges, o = 0, r = i.length; o < r; o++)
				i[o].dataIndex = -1;
			for (var o = 0, r = t.count(); o < r; o++)
			...
			for (var t = new a(this._directed), e = this.nodes, i = this.edges, n = 0; n < e.length; n++)
